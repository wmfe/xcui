...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-630506ee/homeContent.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-8929653a/calendar.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-3a8482f6/pagination.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-4f341690/loading.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-4f341690&scoped=true!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./loading.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-4f341690&scoped=true!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./loading.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".loadWrap[_v-4f341690] {\n  padding: 30px;\n  position: relative;\n}\np[_v-4f341690] {\n  text-align: left;\n  text-indent: 2em;\n}\n.btnGroup[_v-4f341690] {\n  margin-top: 15px;\n}\n.btnGroup label[_v-4f341690] {\n  width: 10%;\n  position: relative;\n  top: 5px;\n  text-align: right;\n}\nselect[_v-4f341690],\noption[_v-4f341690],\nbutton[_v-4f341690] {\n  outline: none;\n}\n", ""]);
...
/***/ function(module, exports) {
	...
	module.exports = "<div _v-4f341690=\"\"><h1 _v-4f341690=\"\">Loading 加载组件</h1>\n<h2 _v-4f341690=\"\">使用场景</h2>\n<p _v-4f341690=\"\">在ajax加载或其他长耗时操作时，在一个页面元素上加入加载中图标，当耗时操作完成后隐藏。</p>\n<h2 _v-4f341690=\"\">组件能力</h2>\n<ul _v-4f341690=\"\">\n<li _v-4f341690=\"\">提供3种css加载样式。</li>\n<li _v-4f341690=\"\">loading需要放在一个拥有定位属性的容器，组件蒙层大小为父元素大小。</li>\n<li _v-4f341690=\"\">css动画颜色可定制。</li>\n<li _v-4f341690=\"\">提供三种可选尺寸。</li>\n<li _v-4f341690=\"\">可通过自定义类名增加特殊定制。</li>\n</ul>\n<div class=\"xcui-demo-container col-md-12 col-xs-12 col-lg-12\" _v-4f341690=\"\">\n    <div class=\"col-md-12 col-xs-12 col-lg-12 xcui-example-container\" _v-4f341690=\"\">\n                    <h3 _v-4f341690=\"\">加载组件</h3>\n                    <div class=\"xcui-demo-wrap col-xs-12 col-md-6 col-lg-6\" _v-4f341690=\"\">\n      <div class=\"loadWrap\" _v-4f341690=\"\">\n          <p _v-4f341690=\"\">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>\n          <xcui-loading :show=\"show\" :type=\"type\" :color=\"color\" :size=\"size\" :classname=\"classname\" _v-4f341690=\"\"></xcui-loading>\n      </div>\n        <div class=\"btnGroup clearfix\" _v-4f341690=\"\">\n            <label class=\"control-label col-md-4\" _v-4f341690=\"\">show：</label>\n            <div class=\"col-md-6\" _v-4f341690=\"\">\n                <button class=\"btn btn-primary\" @click=\"toogleShow\" _v-4f341690=\"\">{{showBtn}}</button>\n            </div>\n        </div>\n        <div class=\"btnGroup clearfix\" _v-4f341690=\"\">\n            <label class=\"control-label col-md-4\" _v-4f341690=\"\">type：</label>\n            <div class=\"col-md-6\" _v-4f341690=\"\">\n                <select class=\"form-control\" v-model=\"type\" _v-4f341690=\"\">\n                    <option _v-4f341690=\"\">load1</option>\n                    <option _v-4f341690=\"\">load2</option>\n                    <option _v-4f341690=\"\">load3</option>\n                </select>\n            </div>\n        </div>\n        <div class=\"btnGroup clearfix\" _v-4f341690=\"\">\n            <label class=\"control-label col-md-4\" _v-4f341690=\"\">size：</label>\n            <div class=\"col-md-6\" _v-4f341690=\"\">\n                <select class=\"form-control\" v-model=\"size\" _v-4f341690=\"\">\n                    <option _v-4f341690=\"\">sm</option>\n                    <option _v-4f341690=\"\">md</option>\n                    <option _v-4f341690=\"\">lg</option>\n                </select>\n            </div>\n        </div>\n        <div class=\"btnGroup clearfix\" _v-4f341690=\"\">\n            <label class=\"control-label col-md-4\" _v-4f341690=\"\">color：</label>\n            <div class=\"col-md-6\" _v-4f341690=\"\">\n                <input class=\"form-control\" type=\"text\" v-model=\"color\" placeholder=\"支持css颜色格式\" _v-4f341690=\"\">\n            </div>\n        </div>\n    </div>\n                    <div class=\"xcui-code-wrap col-xs-12 col-md-6 col-lg-6\" _v-4f341690=\"\"><pre _v-4f341690=\"\"> <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;</span>div</span> <span class=\"token attr-name\" _v-4f341690=\"\">class</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>loadWrap<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n     <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;</span>p</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.<span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;/</span>p</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n     <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;</span>xcui-loading</span> <span class=\"token attr-name\" _v-4f341690=\"\">:show</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>show<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span>\n              <span class=\"token attr-name\" _v-4f341690=\"\">:type</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>type<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span>\n              <span class=\"token attr-name\" _v-4f341690=\"\">:color</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>color<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span>\n              <span class=\"token attr-name\" _v-4f341690=\"\">:size</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>size<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span>\n              <span class=\"token attr-name\" _v-4f341690=\"\">:classname</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>classname<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;/</span>xcui-loading</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;/</span>div</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n   <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;</span>div</span> <span class=\"token attr-name\" _v-4f341690=\"\">class</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>btnGroup clearfix<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n       <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;</span>label</span> <span class=\"token attr-name\" _v-4f341690=\"\">class</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>control-label col-md-4<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>show：<span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;/</span>label</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n       <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;</span>div</span> <span class=\"token attr-name\" _v-4f341690=\"\">class</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>col-md-6<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n           <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;</span>button</span> <span class=\"token attr-name\" _v-4f341690=\"\">class</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>btn btn-primary<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span> <span class=\"token attr-name\" _v-4f341690=\"\">@click</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>toogleShow<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span><span class=\"token punctuation\" _v-4f341690=\"\">{</span><span class=\"token punctuation\" _v-4f341690=\"\">{</span>showBtn<span class=\"token punctuation\" _v-4f341690=\"\">}</span><span class=\"token punctuation\" _v-4f341690=\"\">}</span><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;/</span>button</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n       <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;/</span>div</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n   <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;/</span>div</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n   <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;</span>div</span> <span class=\"token attr-name\" _v-4f341690=\"\">class</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>btnGroup clearfix<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n       <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;</span>label</span>  <span class=\"token attr-name\" _v-4f341690=\"\">class</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>control-label col-md-4<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>type：<span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;/</span>label</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n       <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;</span>div</span> <span class=\"token attr-name\" _v-4f341690=\"\">class</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>col-md-6<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n           <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;</span>select</span> <span class=\"token attr-name\" _v-4f341690=\"\">class</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>form-control<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span> <span class=\"token attr-name\" _v-4f341690=\"\">v-model</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>type<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n               <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;</span>option</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>load1<span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;/</span>option</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n               <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;</span>option</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>load2<span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;/</span>option</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n               <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;</span>option</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>load3<span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;/</span>option</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n           <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;/</span>select</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n       <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;/</span>div</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n   <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;/</span>div</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n   <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;</span>div</span> <span class=\"token attr-name\" _v-4f341690=\"\">class</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>btnGroup clearfix<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n       <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;</span>label</span>  <span class=\"token attr-name\" _v-4f341690=\"\">class</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>control-label col-md-4<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>size：<span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;/</span>label</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n       <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;</span>div</span> <span class=\"token attr-name\" _v-4f341690=\"\">class</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>col-md-6<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n           <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;</span>select</span> <span class=\"token attr-name\" _v-4f341690=\"\">class</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>form-control<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span> <span class=\"token attr-name\" _v-4f341690=\"\">v-model</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>size<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n               <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;</span>option</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>sm<span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;/</span>option</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n               <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;</span>option</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>md<span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;/</span>option</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n               <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;</span>option</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>lg<span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;/</span>option</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n           <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;/</span>select</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n       <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;/</span>div</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n   <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;/</span>div</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n   <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;</span>div</span> <span class=\"token attr-name\" _v-4f341690=\"\">class</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>btnGroup clearfix<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n       <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;</span>label</span> <span class=\"token attr-name\" _v-4f341690=\"\">class</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>control-label col-md-4<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>color：<span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;/</span>label</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n       <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;</span>div</span> <span class=\"token attr-name\" _v-4f341690=\"\">class</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>col-md-6<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n           <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;</span>input</span> <span class=\"token attr-name\" _v-4f341690=\"\">class</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>form-control<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span> <span class=\"token attr-name\" _v-4f341690=\"\">type</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>text<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span> <span class=\"token attr-name\" _v-4f341690=\"\">v-model</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>color<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span> <span class=\"token attr-name\" _v-4f341690=\"\">placeholder</span><span class=\"token attr-value\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">=</span><span class=\"token punctuation\" _v-4f341690=\"\">\"</span>支持css颜色格式<span class=\"token punctuation\" _v-4f341690=\"\">\"</span></span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n       <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;/</span>div</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span>\n   <span class=\"token tag\" _v-4f341690=\"\"><span class=\"token tag\" _v-4f341690=\"\"><span class=\"token punctuation\" _v-4f341690=\"\">&lt;/</span>div</span><span class=\"token punctuation\" _v-4f341690=\"\">&gt;</span></span></pre></div>\n                    </div>\n</div>\n<h2 _v-4f341690=\"\">Props</h2>\n<table class=\"table\" _v-4f341690=\"\">\n<thead _v-4f341690=\"\">\n<tr _v-4f341690=\"\">\n<th _v-4f341690=\"\">名字</th>\n<th _v-4f341690=\"\">类型</th>\n<th _v-4f341690=\"\">默认</th>\n<th _v-4f341690=\"\">描述</th>\n<th _v-4f341690=\"\">可选范围</th>\n<th _v-4f341690=\"\">是否必选</th>\n</tr>\n</thead>\n<tbody _v-4f341690=\"\">\n<tr _v-4f341690=\"\">\n<td _v-4f341690=\"\">show</td>\n<td _v-4f341690=\"\">Boolean</td>\n<td _v-4f341690=\"\">false</td>\n<td _v-4f341690=\"\">控制显示隐藏</td>\n<td _v-4f341690=\"\">true/false</td>\n<td _v-4f341690=\"\">必选</td>\n</tr>\n<tr _v-4f341690=\"\">\n<td _v-4f341690=\"\">type</td>\n<td _v-4f341690=\"\">String</td>\n<td _v-4f341690=\"\">load2</td>\n<td _v-4f341690=\"\">控制样式选择</td>\n<td _v-4f341690=\"\">load1-load3</td>\n<td _v-4f341690=\"\">可选</td>\n</tr>\n<tr _v-4f341690=\"\">\n<td _v-4f341690=\"\">size</td>\n<td _v-4f341690=\"\">String</td>\n<td _v-4f341690=\"\">md</td>\n<td _v-4f341690=\"\">控制大小</td>\n<td _v-4f341690=\"\">sm/md/lg</td>\n<td _v-4f341690=\"\">可选</td>\n</tr>\n<tr _v-4f341690=\"\">\n<td _v-4f341690=\"\">color</td>\n<td _v-4f341690=\"\">String</td>\n<td _v-4f341690=\"\">无</td>\n<td _v-4f341690=\"\">控制颜色</td>\n<td _v-4f341690=\"\">css色值</td>\n<td _v-4f341690=\"\">可选</td>\n</tr>\n<tr _v-4f341690=\"\">\n<td _v-4f341690=\"\">classname</td>\n<td _v-4f341690=\"\">String</td>\n<td _v-4f341690=\"\">无</td>\n<td _v-4f341690=\"\">自定义类名</td>\n<td _v-4f341690=\"\"></td>\n<td _v-4f341690=\"\">可选</td>\n</tr>\n</tbody>\n</table>\n</div>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-6a66b779/popover.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-e2076c52/tooltip.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-2ecbd060/suggestion.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-2ecbd060&scoped=true!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./suggestion.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-2ecbd060&scoped=true!./../../node_modules/less-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./suggestion.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".block-item[_v-2ecbd060] {\n  margin: 0 30px 50px;\n  float: left;\n}\n", ""]);
...
/***/ function(module, exports) {
	...
	module.exports = "<div _v-2ecbd060=\"\"><h1 _v-2ecbd060=\"\">Suggestion 自动完成/建议</h1>\n<h2 _v-2ecbd060=\"\">使用场景</h2>\n<p _v-2ecbd060=\"\">用户输入相关词语时进行输入建议(suggestions), 自动完成</p>\n<h1 _v-2ecbd060=\"\">Demo</h1>\n<div class=\"xcui-demo-container col-md-12 col-xs-12 col-lg-12\" _v-2ecbd060=\"\">\n<div class=\"col-md-12 col-xs-12 col-lg-12 xcui-example-container\" _v-2ecbd060=\"\">\n                    <h3 _v-2ecbd060=\"\">string数组 sugs:</h3>\n                    <div class=\"xcui-demo-wrap col-xs-12 col-md-6 col-lg-6\" _v-2ecbd060=\"\">\n  <table class=\"table\" style=\"width:400px\" _v-2ecbd060=\"\">\n    <thead _v-2ecbd060=\"\">\n        <tr _v-2ecbd060=\"\">\n            <th _v-2ecbd060=\"\">dataText</th>\n            <th _v-2ecbd060=\"\">dataValue</th>\n        </tr>\n    </thead>\n    <tbody _v-2ecbd060=\"\">\n        <tr _v-2ecbd060=\"\">\n            <td _v-2ecbd060=\"\">constellation : {{constellation}}</td>\n            <td _v-2ecbd060=\"\">constellationValue : {{constellationValue}}</td>\n        </tr>\n    </tbody>\n  </table>\n  <div style=\"width:200px\" _v-2ecbd060=\"\">\n      <xcui-suggestion id=\"constellation\" name=\"constellation\" placeholder=\"请输入星座\" :data-text.sync=\"constellation\" :data-value.sync=\"constellationValue\" :suggestions=\"constellationSuggestions\" _v-2ecbd060=\"\">\n      </xcui-suggestion>\n  </div>\n</div>\n                    <div class=\"xcui-code-wrap col-xs-12 col-md-6 col-lg-6\" _v-2ecbd060=\"\"><pre _v-2ecbd060=\"\"> <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>table</span> <span class=\"token attr-name\" _v-2ecbd060=\"\">class</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span>table<span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span><span class=\"token style-attr language-css\" _v-2ecbd060=\"\"><span class=\"token attr-name\" _v-2ecbd060=\"\"> <span class=\"token attr-name\" _v-2ecbd060=\"\">style</span></span><span class=\"token punctuation\" _v-2ecbd060=\"\">=\"</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token property\" _v-2ecbd060=\"\">width</span><span class=\"token punctuation\" _v-2ecbd060=\"\">:</span>400px</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n   <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>thead</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n       <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>tr</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n           <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>th</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>dataText<span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>th</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n           <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>th</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>dataValue<span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>th</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n       <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>tr</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n   <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>thead</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n   <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>tbody</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n       <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>tr</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n           <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>td</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>constellation : <span class=\"token punctuation\" _v-2ecbd060=\"\">{</span><span class=\"token punctuation\" _v-2ecbd060=\"\">{</span>constellation<span class=\"token punctuation\" _v-2ecbd060=\"\">}</span><span class=\"token punctuation\" _v-2ecbd060=\"\">}</span><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>td</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n           <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>td</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>constellationValue : <span class=\"token punctuation\" _v-2ecbd060=\"\">{</span><span class=\"token punctuation\" _v-2ecbd060=\"\">{</span>constellationValue<span class=\"token punctuation\" _v-2ecbd060=\"\">}</span><span class=\"token punctuation\" _v-2ecbd060=\"\">}</span><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>td</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n       <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>tr</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n   <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>tbody</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>table</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>div</span><span class=\"token style-attr language-css\" _v-2ecbd060=\"\"><span class=\"token attr-name\" _v-2ecbd060=\"\"> <span class=\"token attr-name\" _v-2ecbd060=\"\">style</span></span><span class=\"token punctuation\" _v-2ecbd060=\"\">=\"</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token property\" _v-2ecbd060=\"\">width</span><span class=\"token punctuation\" _v-2ecbd060=\"\">:</span>200px</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n     <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>xcui-suggestion</span>\n       <span class=\"token attr-name\" _v-2ecbd060=\"\">id</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span>constellation<span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span>\n       <span class=\"token attr-name\" _v-2ecbd060=\"\">name</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span>constellation<span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span>\n       <span class=\"token attr-name\" _v-2ecbd060=\"\">placeholder</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span>请输入星座<span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span>\n       <span class=\"token attr-name\" _v-2ecbd060=\"\">:data-text.sync</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span>constellation<span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span>\n       <span class=\"token attr-name\" _v-2ecbd060=\"\">:data-value.sync</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span>constellationValue<span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span>\n       <span class=\"token attr-name\" _v-2ecbd060=\"\">:suggestions</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span>constellationSuggestions<span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n     <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>xcui-suggestion</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>div</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span></pre></div>\n                    </div>\n    <div class=\"col-md-12 col-xs-12 col-lg-12 xcui-example-container\" _v-2ecbd060=\"\">\n                    <h3 _v-2ecbd060=\"\">object数组 sugs:</h3>\n                    <div class=\"xcui-demo-wrap col-xs-12 col-md-6 col-lg-6\" _v-2ecbd060=\"\">\n        <table class=\"table\" style=\"width:400px\" _v-2ecbd060=\"\">\n              <thead _v-2ecbd060=\"\">\n                  <tr _v-2ecbd060=\"\">\n                      <th _v-2ecbd060=\"\">dataText</th>\n                      <th _v-2ecbd060=\"\">dataValue</th>\n                  </tr>\n              </thead>\n              <tbody _v-2ecbd060=\"\">\n                  <tr _v-2ecbd060=\"\">\n                      <td _v-2ecbd060=\"\">cityName : {{cityName}}</td>\n                      <td _v-2ecbd060=\"\">cityId : {{cityId}}</td>\n                  </tr>\n              </tbody>\n          </table>\n          <div style=\"width:200px\" _v-2ecbd060=\"\">\n              <xcui-suggestion id=\"city\" name=\"city\" placeholder=\"请输入城市\" :data-text.sync=\"cityName\" :data-value.sync=\"cityId\" :suggestions=\"citySuggestions\" _v-2ecbd060=\"\">\n              </xcui-suggestion>\n          </div>\n    </div>\n                    <div class=\"xcui-code-wrap col-xs-12 col-md-6 col-lg-6\" _v-2ecbd060=\"\"><pre _v-2ecbd060=\"\"> <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>table</span> <span class=\"token attr-name\" _v-2ecbd060=\"\">class</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span>table<span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span><span class=\"token style-attr language-css\" _v-2ecbd060=\"\"><span class=\"token attr-name\" _v-2ecbd060=\"\"> <span class=\"token attr-name\" _v-2ecbd060=\"\">style</span></span><span class=\"token punctuation\" _v-2ecbd060=\"\">=\"</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token property\" _v-2ecbd060=\"\">width</span><span class=\"token punctuation\" _v-2ecbd060=\"\">:</span>400px</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n       <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>thead</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n           <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>tr</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n               <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>th</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>dataText<span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>th</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n               <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>th</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>dataValue<span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>th</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n           <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>tr</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n       <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>thead</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n       <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>tbody</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n           <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>tr</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n               <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>td</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>cityName : <span class=\"token punctuation\" _v-2ecbd060=\"\">{</span><span class=\"token punctuation\" _v-2ecbd060=\"\">{</span>cityName<span class=\"token punctuation\" _v-2ecbd060=\"\">}</span><span class=\"token punctuation\" _v-2ecbd060=\"\">}</span><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>td</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n               <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>td</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>cityId : <span class=\"token punctuation\" _v-2ecbd060=\"\">{</span><span class=\"token punctuation\" _v-2ecbd060=\"\">{</span>cityId<span class=\"token punctuation\" _v-2ecbd060=\"\">}</span><span class=\"token punctuation\" _v-2ecbd060=\"\">}</span><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>td</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n           <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>tr</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n       <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>tbody</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n   <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>table</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n   <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>div</span><span class=\"token style-attr language-css\" _v-2ecbd060=\"\"><span class=\"token attr-name\" _v-2ecbd060=\"\"> <span class=\"token attr-name\" _v-2ecbd060=\"\">style</span></span><span class=\"token punctuation\" _v-2ecbd060=\"\">=\"</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token property\" _v-2ecbd060=\"\">width</span><span class=\"token punctuation\" _v-2ecbd060=\"\">:</span>200px</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n       <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>xcui-suggestion</span> <span class=\"token attr-name\" _v-2ecbd060=\"\">id</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span>city<span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span> <span class=\"token attr-name\" _v-2ecbd060=\"\">name</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span>city<span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span> <span class=\"token attr-name\" _v-2ecbd060=\"\">placeholder</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span>请输入城市<span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span> <span class=\"token attr-name\" _v-2ecbd060=\"\">:data-text.sync</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span>cityName<span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span> <span class=\"token attr-name\" _v-2ecbd060=\"\">:data-value.sync</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span>cityId<span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span> <span class=\"token attr-name\" _v-2ecbd060=\"\">:suggestions</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span>citySuggestions<span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n       <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>xcui-suggestion</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n   <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>div</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span></pre></div>\n                    </div>\n    <div class=\"col-md-12 col-xs-12 col-lg-12 xcui-example-container\" _v-2ecbd060=\"\">\n                    <h3 _v-2ecbd060=\"\">远程sug，string数组 sugs:</h3>\n                    <div class=\"xcui-demo-wrap col-xs-12 col-md-6 col-lg-6\" _v-2ecbd060=\"\">\n      <table class=\"table\" style=\"width:400px\" _v-2ecbd060=\"\">\n          <thead _v-2ecbd060=\"\">\n              <tr _v-2ecbd060=\"\">\n                  <th _v-2ecbd060=\"\">dataText</th>\n                  <th _v-2ecbd060=\"\">dataValue</th>\n              </tr>\n          </thead>\n          <tbody _v-2ecbd060=\"\">\n              <tr _v-2ecbd060=\"\">\n                  <td _v-2ecbd060=\"\">requestWord : {{requestWord}}</td>\n                  <td _v-2ecbd060=\"\"> </td>\n              </tr>\n          </tbody>\n      </table>\n      <div style=\"width:200px\" _v-2ecbd060=\"\">\n              <xcui-suggestion placeholder=\"\" :check=\"false\" :data-text.sync=\"requestWord\" :suggestions=\"remoteSug\" :input-callback=\"request\" _v-2ecbd060=\"\">&gt;\n              </xcui-suggestion>\n      </div>\n    </div>\n                    <div class=\"xcui-code-wrap col-xs-12 col-md-6 col-lg-6\" _v-2ecbd060=\"\"><pre _v-2ecbd060=\"\"> <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>table</span> <span class=\"token attr-name\" _v-2ecbd060=\"\">class</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span>table<span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span><span class=\"token style-attr language-css\" _v-2ecbd060=\"\"><span class=\"token attr-name\" _v-2ecbd060=\"\"> <span class=\"token attr-name\" _v-2ecbd060=\"\">style</span></span><span class=\"token punctuation\" _v-2ecbd060=\"\">=\"</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token property\" _v-2ecbd060=\"\">width</span><span class=\"token punctuation\" _v-2ecbd060=\"\">:</span>400px</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n     <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>thead</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n         <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>tr</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n             <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>th</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>dataText<span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>th</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n             <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>th</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>dataValue<span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>th</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n         <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>tr</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n     <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>thead</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n     <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>tbody</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n         <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>tr</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n             <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>td</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>requestWord : <span class=\"token punctuation\" _v-2ecbd060=\"\">{</span><span class=\"token punctuation\" _v-2ecbd060=\"\">{</span>requestWord<span class=\"token punctuation\" _v-2ecbd060=\"\">}</span><span class=\"token punctuation\" _v-2ecbd060=\"\">}</span><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>td</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n             <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>td</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span> <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>td</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n         <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>tr</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n     <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>tbody</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>table</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>div</span><span class=\"token style-attr language-css\" _v-2ecbd060=\"\"><span class=\"token attr-name\" _v-2ecbd060=\"\"> <span class=\"token attr-name\" _v-2ecbd060=\"\">style</span></span><span class=\"token punctuation\" _v-2ecbd060=\"\">=\"</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token property\" _v-2ecbd060=\"\">width</span><span class=\"token punctuation\" _v-2ecbd060=\"\">:</span>200px</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n         <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>xcui-suggestion</span> <span class=\"token attr-name\" _v-2ecbd060=\"\">placeholder</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span>\n                     <span class=\"token attr-name\" _v-2ecbd060=\"\">:check</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span>false</span>\n                     <span class=\"token attr-name\" _v-2ecbd060=\"\">:data-text.sync</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span>requestWord<span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span>\n                     <span class=\"token attr-name\" _v-2ecbd060=\"\">:suggestions</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span>remoteSug<span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span>\n                     <span class=\"token attr-name\" _v-2ecbd060=\"\">:input-callback</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span>request<span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>&gt;\n         <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>xcui-suggestion</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>div</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span></pre></div>\n                    </div>\n    <div class=\"col-md-12 col-xs-12 col-lg-12 xcui-example-container\" _v-2ecbd060=\"\">\n                    <h3 _v-2ecbd060=\"\">远程sug，object数组 sugs:</h3>\n                    <div class=\"xcui-demo-wrap col-xs-12 col-md-6 col-lg-6\" _v-2ecbd060=\"\">\n        <div class=\"block-item\" _v-2ecbd060=\"\">\n          <table class=\"table table-striped table-bordered\" style=\"width:400px\" _v-2ecbd060=\"\">\n              <thead _v-2ecbd060=\"\">\n                  <tr _v-2ecbd060=\"\">\n                      <th _v-2ecbd060=\"\">dataText</th>\n                      <th _v-2ecbd060=\"\">dataValue</th>\n                  </tr>\n              </thead>\n              <tbody _v-2ecbd060=\"\">\n                  <tr _v-2ecbd060=\"\">\n                      <td _v-2ecbd060=\"\">requestWord2 : {{requestWord2}}</td>\n                      <td _v-2ecbd060=\"\">requestValue2 : {{requestValue2}}</td>\n                  </tr>\n              </tbody>\n          </table>\n          <div style=\"width:200px\" _v-2ecbd060=\"\">\n                  <xcui-suggestion placeholder=\"\" :check=\"false\" :data-text.sync=\"requestWord2\" :data-value.sync=\"requestValue2\" :suggestions=\"remoteSug2\" :input-callback=\"request2\" _v-2ecbd060=\"\">\n                  </xcui-suggestion>\n          </div>\n        </div>\n    </div>\n                    <div class=\"xcui-code-wrap col-xs-12 col-md-6 col-lg-6\" _v-2ecbd060=\"\"><pre _v-2ecbd060=\"\"> <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>div</span> <span class=\"token attr-name\" _v-2ecbd060=\"\">class</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span>block-item<span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n   <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>table</span> <span class=\"token attr-name\" _v-2ecbd060=\"\">class</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span>table table-striped table-bordered<span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span><span class=\"token style-attr language-css\" _v-2ecbd060=\"\"><span class=\"token attr-name\" _v-2ecbd060=\"\"> <span class=\"token attr-name\" _v-2ecbd060=\"\">style</span></span><span class=\"token punctuation\" _v-2ecbd060=\"\">=\"</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token property\" _v-2ecbd060=\"\">width</span><span class=\"token punctuation\" _v-2ecbd060=\"\">:</span>400px</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n       <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>thead</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n           <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>tr</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n               <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>th</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>dataText<span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>th</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n               <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>th</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>dataValue<span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>th</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n           <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>tr</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n       <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>thead</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n       <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>tbody</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n           <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>tr</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n               <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>td</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>requestWord2 : <span class=\"token punctuation\" _v-2ecbd060=\"\">{</span><span class=\"token punctuation\" _v-2ecbd060=\"\">{</span>requestWord2<span class=\"token punctuation\" _v-2ecbd060=\"\">}</span><span class=\"token punctuation\" _v-2ecbd060=\"\">}</span><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>td</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n               <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>td</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>requestValue2 : <span class=\"token punctuation\" _v-2ecbd060=\"\">{</span><span class=\"token punctuation\" _v-2ecbd060=\"\">{</span>requestValue2<span class=\"token punctuation\" _v-2ecbd060=\"\">}</span><span class=\"token punctuation\" _v-2ecbd060=\"\">}</span><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>td</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n           <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>tr</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n       <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>tbody</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n   <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>table</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n   <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>div</span><span class=\"token style-attr language-css\" _v-2ecbd060=\"\"><span class=\"token attr-name\" _v-2ecbd060=\"\"> <span class=\"token attr-name\" _v-2ecbd060=\"\">style</span></span><span class=\"token punctuation\" _v-2ecbd060=\"\">=\"</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token property\" _v-2ecbd060=\"\">width</span><span class=\"token punctuation\" _v-2ecbd060=\"\">:</span>200px</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n           <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;</span>xcui-suggestion</span> <span class=\"token attr-name\" _v-2ecbd060=\"\">placeholder</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span>\n                       <span class=\"token attr-name\" _v-2ecbd060=\"\">:check</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span>false</span>\n                       <span class=\"token attr-name\" _v-2ecbd060=\"\">:data-text.sync</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span>requestWord2<span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span>\n                       <span class=\"token attr-name\" _v-2ecbd060=\"\">:data-value.sync</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span>requestValue2<span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span>\n                       <span class=\"token attr-name\" _v-2ecbd060=\"\">:suggestions</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span>remoteSug2<span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span>\n                       <span class=\"token attr-name\" _v-2ecbd060=\"\">:input-callback</span><span class=\"token attr-value\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">=</span><span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span>request2<span class=\"token punctuation\" _v-2ecbd060=\"\">\"</span></span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n           <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>xcui-suggestion</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n   <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>div</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span>\n <span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token tag\" _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">&lt;/</span>div</span><span class=\"token punctuation\" _v-2ecbd060=\"\">&gt;</span></span></pre></div>\n                    </div>\n</div>\n<h2 _v-2ecbd060=\"\">数据格式支持</h2>\n<p _v-2ecbd060=\"\">组件支持两种<code _v-2ecbd060=\"\">数据格式</code>：</p>\n<ul _v-2ecbd060=\"\">\n<li _v-2ecbd060=\"\">Object:</li>\n</ul>\n<pre _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">[</span><span class=\"token punctuation\" _v-2ecbd060=\"\">{</span>\n    text<span class=\"token punctuation\" _v-2ecbd060=\"\">:</span><span class=\"token string\" _v-2ecbd060=\"\">\"北京\"</span><span class=\"token punctuation\" _v-2ecbd060=\"\">,</span>\n    value<span class=\"token punctuation\" _v-2ecbd060=\"\">:</span><span class=\"token string\" _v-2ecbd060=\"\">\"103\"</span>\n<span class=\"token punctuation\" _v-2ecbd060=\"\">}</span><span class=\"token punctuation\" _v-2ecbd060=\"\">,</span><span class=\"token punctuation\" _v-2ecbd060=\"\">{</span>\n    text<span class=\"token punctuation\" _v-2ecbd060=\"\">:</span><span class=\"token string\" _v-2ecbd060=\"\">\"上海\"</span><span class=\"token punctuation\" _v-2ecbd060=\"\">,</span>\n    value<span class=\"token punctuation\" _v-2ecbd060=\"\">:</span><span class=\"token string\" _v-2ecbd060=\"\">\"131\"</span>\n<span class=\"token punctuation\" _v-2ecbd060=\"\">}</span><span class=\"token punctuation\" _v-2ecbd060=\"\">,</span>\n    ……\n<span class=\"token punctuation\" _v-2ecbd060=\"\">]</span>\n</pre>\n<ul _v-2ecbd060=\"\">\n<li _v-2ecbd060=\"\">Array:</li>\n</ul>\n<pre _v-2ecbd060=\"\"><span class=\"token punctuation\" _v-2ecbd060=\"\">[</span><span class=\"token string\" _v-2ecbd060=\"\">\"北京\"</span><span class=\"token punctuation\" _v-2ecbd060=\"\">,</span><span class=\"token string\" _v-2ecbd060=\"\">\"上海\"</span><span class=\"token punctuation\" _v-2ecbd060=\"\">,</span>……<span class=\"token punctuation\" _v-2ecbd060=\"\">]</span>\n</pre>\n<h2 _v-2ecbd060=\"\">参数说明</h2>\n<table class=\"table\" _v-2ecbd060=\"\">\n<thead _v-2ecbd060=\"\">\n<tr _v-2ecbd060=\"\">\n<th _v-2ecbd060=\"\">参数</th>\n<th _v-2ecbd060=\"\">类型</th>\n<th _v-2ecbd060=\"\">双向</th>\n<th _v-2ecbd060=\"\">说明</th>\n</tr>\n</thead>\n<tbody _v-2ecbd060=\"\">\n<tr _v-2ecbd060=\"\">\n<td _v-2ecbd060=\"\">id</td>\n<td _v-2ecbd060=\"\">String</td>\n<td _v-2ecbd060=\"\"></td>\n<td _v-2ecbd060=\"\">input的id</td>\n</tr>\n<tr _v-2ecbd060=\"\">\n<td _v-2ecbd060=\"\">name</td>\n<td _v-2ecbd060=\"\">String</td>\n<td _v-2ecbd060=\"\"></td>\n<td _v-2ecbd060=\"\">input的name属性</td>\n</tr>\n<tr _v-2ecbd060=\"\">\n<td _v-2ecbd060=\"\">className</td>\n<td _v-2ecbd060=\"\">String</td>\n<td _v-2ecbd060=\"\"></td>\n<td _v-2ecbd060=\"\">类名</td>\n</tr>\n<tr _v-2ecbd060=\"\">\n<td _v-2ecbd060=\"\">disabled</td>\n<td _v-2ecbd060=\"\">Boolean</td>\n<td _v-2ecbd060=\"\"></td>\n<td _v-2ecbd060=\"\">input的disabled属性</td>\n</tr>\n<tr _v-2ecbd060=\"\">\n<td _v-2ecbd060=\"\">placeholder</td>\n<td _v-2ecbd060=\"\">String</td>\n<td _v-2ecbd060=\"\"></td>\n<td _v-2ecbd060=\"\">input提示</td>\n</tr>\n<tr _v-2ecbd060=\"\">\n<td _v-2ecbd060=\"\">dataText</td>\n<td _v-2ecbd060=\"\">String</td>\n<td _v-2ecbd060=\"\">是</td>\n<td _v-2ecbd060=\"\">sug文本,展示给用户的sug值</td>\n</tr>\n<tr _v-2ecbd060=\"\">\n<td _v-2ecbd060=\"\">dataValue</td>\n<td _v-2ecbd060=\"\">String or Object</td>\n<td _v-2ecbd060=\"\">是</td>\n<td _v-2ecbd060=\"\">所选sug项</td>\n</tr>\n<tr _v-2ecbd060=\"\">\n<td _v-2ecbd060=\"\">suggestions</td>\n<td _v-2ecbd060=\"\">Array</td>\n<td _v-2ecbd060=\"\"></td>\n<td _v-2ecbd060=\"\">sug list</td>\n</tr>\n<tr _v-2ecbd060=\"\">\n<td _v-2ecbd060=\"\">check</td>\n<td _v-2ecbd060=\"\">Boolean@default:false</td>\n<td _v-2ecbd060=\"\"></td>\n<td _v-2ecbd060=\"\">是否要做sug匹配，如果想用本组件实现远程sug，设为false</td>\n</tr>\n<tr _v-2ecbd060=\"\">\n<td _v-2ecbd060=\"\">inputCallback</td>\n<td _v-2ecbd060=\"\">Function</td>\n<td _v-2ecbd060=\"\"></td>\n<td _v-2ecbd060=\"\">input事件回调，可以本时机触发远程sug异步请求</td>\n</tr>\n</tbody>\n</table>\n</div>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-9b6f2fd0/datepicker.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-c0e0271e/dateRangePicker.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-28fbd7db/message.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-a6fdf8f2/inputNumber.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-708d2d09/progress.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-32b9d2be/pageloading.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
