...
<demo>
    <example title="基础使用">
        <button class="btn btn-default" @click="modal1 = true">显示对话框</button>
        <xcui-modal
        v-model="modal1"
        title="基础弹窗">
    ...
    <example title="定义元素的显示">
        <button class="btn btn-default" @click="modal2 = true">自定义页头</button>
        <button class="btn btn-default" @click="modal3 = true">不带标题栏</button>
        <button class="btn btn-default" @click="modal4 = true">不带关闭按钮</button>
        <button class="btn btn-default" @click="modal5 = true">不带页脚</button>
        <button class="btn btn-default" @click="modal6 = true">不带关闭按钮和页脚</button>
        <xcui-modal
        v-model="modal2"
    ...
    <example title="自定义样式">
        <button class="btn btn-default" @click="modal7 = true">Full对话框</button>
        <button class="btn btn-default" @click="modal8 = true">Small对话框</button>
        <button class="btn btn-default" @click="modal9 = true">自定义Style</button>
        <button class="btn btn-default" @click="modal10 = true">自定义class-name</button>
        <xcui-modal
        v-model="modal7"
        :size="'full'"
        title="Full对话框">
