<template lang="md">
    ...
    <demo>
        <example title="基础用法">
            ...
            <xcui-info>
                在`xcui-checkbox`中使用`v-model`绑定变量，默认绑定变量的值是`Boolean`, 选中时为`true`。
            </xcui-info>
            <xcui-script>
                export default {
                    data() {
        ...
        <example title="多选框组">
            ...
            <xcui-info>
                通过将`xcui-checkbox`作为`xcui-checkbox-group`的直接子元素
            </xcui-info>
        </example>
        <example title="全选和部分选中">
            ...
            <xcui-info>
                `indeterminate`属性表示多选框的不确定状态，常用于实现部分选中功能。本例实现了全选和部分选中功能。
            </xcui-info>
        </example>
    </demo>
