...
<demo>
    <example title="信息提示组件">
        ...
        <xcui-toaster :options="options"></xcui-toaster>
    </example>
</demo>
...
| 名字 | 类型 | 默认 | 描述 |
|-----|-----|-----|-----|
| options | Object | 无 | type：指定提示信息的类型，默认为info类型；可自行配置，有四种选择info、success、error、warning<br>content：必选项，提示信息内容<br>duration：默认2秒自动关闭，可自行配置 |
</template>
